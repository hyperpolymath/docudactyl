...
pub const DATA_WORDS: u16 = 27; // 23 original + 4 for investigative stage data fields
pub const PTR_WORDS: u16 = 38; // 30 original + 8 for investigative stage pointers
...
// Investigative stage data offsets (packed 32-bit fields in extended data region)
pub const OFF_REDACT_COUNT: usize = 184; // @61 UInt32
pub const OFF_FINANCIAL_AMOUNTS: usize = 188; // @65 UInt32
pub const OFF_FINANCIAL_ACCOUNTS: usize = 192; // @66 UInt32
pub const OFF_LEGAL_CASES: usize = 196; // @71 UInt32
pub const OFF_LEGAL_DOCKETS: usize = 200; // @72 UInt32 (was going to be offset 200 but needs to fit)
pub const OFF_LEGAL_STATUTES: usize = 204; // @73 UInt32 (technically this is a 6th u32 in the last data word = byte 200)
// Note: we need one more data word (originally 23 words = 184 bytes,
// now 25 words = 200 bytes to hold offsets 184-207)
// Offset 184: word 24 (REDACT_COUNT:4, FINANCIAL_AMOUNTS:4)
// Offset 192: word 25 (FINANCIAL_ACCOUNTS:4, LEGAL_CASES:4)
// Need DATA_WORDS = 27 for all 7 u32 fields
pub const OFF_SPEAKER_COUNT: usize = 208; // @76 UInt32
...
// Investigative stage pointers (bits 20-23)
pub const PTR_REDACT_STATUS: usize = 30; // @59
pub const PTR_REDACT_REASON: usize = 31; // @60
pub const PTR_FINANCIAL_STATUS: usize = 32; // @63
pub const PTR_FINANCIAL_REASON: usize = 33; // @64
pub const PTR_LEGAL_STATUS: usize = 34; // @69
pub const PTR_LEGAL_REASON: usize = 35; // @70
pub const PTR_SPEAKER_STATUS: usize = 36; // @74
pub const PTR_SPEAKER_REASON: usize = 37; // @75
