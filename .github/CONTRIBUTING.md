...
git clone <https://github.com/hyperpolymath/docudactyl.git> cd
docudactyl
...
toolbox create docudactyl-dev toolbox enter docudactyl-dev \# Install
...
docudactyl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/docudactyl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/docudactyl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/docudactyl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/docudactyl/labels/perimeter-3) — Community sandbox scope
