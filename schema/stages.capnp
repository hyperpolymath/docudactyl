...
struct StageResults {
  ...
  # Detects overlay-based redactions in PDFs (common in legal releases).
  # status: "clean" / "redacted" / "not_applicable" / "error"
  redactStatus           @59 :Text;
  redactReason           @60 :Text;
  redactCount            @61 :UInt32;   # Number of redaction annotations found
  redactSensitivity      @62 :Float64;  # Reserved for future confidence scoring

  # ── Financial Entity Extraction (bit 21) ──────────────────────────
  # Pattern-based detection of monetary amounts, account numbers, currency codes.
  financialStatus        @63 :Text;     # "entities_found" / "none_found"
  financialReason        @64 :Text;
  financialAmounts       @65 :UInt32;   # Count of monetary amount patterns
  financialAccounts      @66 :UInt32;   # Count of account-like number patterns

  # ── Legal NER (bit 22) ────────────────────────────────────────────
  # Domain-specific legal entity detection: case citations, docket numbers, statutes.
  legalNerStatus         @67 :Text;     # "entities_found" / "none_found" (was @69, renumbered)
  legalNerReason         @68 :Text;
  legalCaseCitations     @69 :UInt32;   # "Doe v. Epstein" patterns
  legalDocketRefs        @70 :UInt32;   # "No. 08-cv-1234" patterns
  legalStatuteRefs       @71 :UInt32;   # "U.S.C." / "§" patterns

  # ── Speaker Identification (bit 23) ───────────────────────────────
  # ML-based speaker diarization for audio/video depositions and interviews.
  speakerIdStatus        @72 :Text;     # "ok" / "model_not_found" / "not_available"
  speakerIdReason        @73 :Text;
  speakerCount           @74 :UInt32;   # Number of distinct speakers detected
