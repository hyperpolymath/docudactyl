...
(state
  ...
  (integration-docs
    (doc "docs/INTEGRATION-PLAN-DOCUDACTYL.md"
      (description "Docudactyl's role in the Docudactyl → Lithoglyph → Bofig pipeline, extracted from master plan"))
    (doc "docs/EPSTEIN-EXTRACTION-TESTS.md"
      (description "Epstein Files extraction tests and benchmarks — Docudactyl phases 1.1-1.7, 29 tests, 13 benchmarks"))
    (master-plan "bofig/docs/INTEGRATION-PLAN.md")
    (master-pathway "bofig/docs/EPSTEIN-FILES-WORK-PATHWAY.md"))
