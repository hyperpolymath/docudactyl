...
= Docudactyl
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=openssourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/docudactyl"]

image:https://img.shields.io/badge/License-MPL_2.0-blue.svg[MPL-2.0,link="https://github.com/hyperpolymath/palimpsest-license"]
...
This project is licensed under **MPL-2.0** (MPL-2.0).

The full licence text is in `license/MPL-2.0.txt`. The canonical source is the https://github.com/hyperpolymath/palimpsest-license[palimpsest-license] repository.
